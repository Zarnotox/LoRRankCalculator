...
export class ColorService {
    ...
    constructor() {
        ...
        this.colorSchemeEase(this.gold, this.platinum);
    }

    start() {
        this.colorSchemeEase(this.gold, this.master)
    }
    ...
    colorSchemeEase(startColor: ColorScheme, endColor: ColorScheme, percentage: number = 0) {
        ...
        percentage += 0.02;
        if (percentage <= 1) {
            new Promise(() => setTimeout(() => this.colorSchemeEase(startColor, endColor, percentage), 0));
        }
    }
